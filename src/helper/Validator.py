...
class Validator(object):
    ...
    def __allows_null_param_path__(self, path: str) -> bool:
    ...
    def __is_allowed_http_method__(self, method: str, path: str) -> bool:
    ...
    def check_parameters(self) -> (str, dict):
